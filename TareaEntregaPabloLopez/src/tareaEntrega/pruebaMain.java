...
public class pruebaMain {
    ...
    public static void main(String[] args) {
        ...
        Profesor profesor = new Profesor("987654321B", "Maria", "Perez", "lopez", dir1);
    ...
    /**
     * Metodo que muestra el menú de opciones para insertar, borrar, buscar o listar las personas del colegio
     * @return : entero
     */
